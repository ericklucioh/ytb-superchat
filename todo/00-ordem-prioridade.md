...
20. `todo/19-src-overlay-iframe-crossorigin-guard.md`
21. `todo/20-overlay-crossorigin-parent-guard.md`
22. `todo/21-overlay-invalid-json-websocket.md`
23. `todo/22-wrappers-dedup-and-encoding-review.md`

## Sequencia sugerida
1. Fechar os riscos de captura da extensao e a ponte.
2. Executar o smoke final do Go se ainda quiser validar em ambiente real.
3. Manter os itens concluidos como referencia historica apenas.

## Observacao
Os itens concluidos ja foram implementados e validados. Os alias legados `13` a `15` permanecem como referencia de historico, mas seguem o mesmo caminho de implementacao dos itens canonicos `01` a `03`.
